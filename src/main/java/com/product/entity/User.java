...
public class User {
    ...
    private Integer validateMobile;
    ...
    public Short getMailvalidatect() {
        return mailvalidatect;
    }

    public void setMailvalidatect(Short mailvalidatect) {
        this.mailvalidatect = mailvalidatect;
    }
    ...
    public Integer getValidateMobile() {
        return validateMobile;
    }

    public void setValidateMobile(Integer validateMobile) {
